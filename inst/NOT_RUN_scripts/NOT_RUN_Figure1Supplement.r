...
df_stat = merge(df_stat, tr, by.x = "transp", by.y = "transponder", all.x = TRUE, all.y = FALSE)
...
daily_visits = unique(ActivityDataPerPeriod[sleep == 0, .(counter, in_, out_, box)])
