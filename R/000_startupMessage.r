...
HOW TO USE:
Dataset 1: 'ActivityDataPerMimute' Contains male song and female box visits per minute
Dataset 2: 'ActivityDataPerMimute' Contains male song and female box visits per period (before, during or after female box visit)
